        ...
        <div class="form-container">
            <form method="POST" action="{{ url('/alternatif/update/' . $alternatif->id) }}" class="form-horizontal">
                ...
                <div class="form-section">
                    ...
                    <input type="text" class="form-control" name="kode_alternatif" placeholder="Kode Alternatif"
                        value="{{ $alternatif->kode_alternatif }}">
                </div>
                <div class="form-section">
                    <label for="kriteria_1">C1</label>
                    <input type="text" class="form-control" name="kriteria_1" placeholder="Nilai Kriteria (Penghasilan)"
                        value="{{ $alternatif->kriteria_1 }}">
                </div>
                <div class="form-section">
                    <label for="kriteria_2">C2</label>
                    <input type="text" class="form-control" name="kriteria_2"
                        placeholder="Nilai Kriteria (Status Perkawinan)" value="{{ $alternatif->kriteria_2 }}">
                </div>
                <div class="form-section">
                    <label for="kriteria_3">C3</label>
                    <input type="text" class="form-control" name="kriteria_3"
                        placeholder="Nilai Kriteria (Jumlah Tanggungan)" value="{{ $alternatif->kriteria_3 }}">
                </div>
